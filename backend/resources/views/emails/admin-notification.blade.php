...
<head>
    ...
    <style>
        @php
            $colorMap = [
                'red' => ['primary' => '#dc2626', 'dark' => '#b91c1c', 'light' => '#fef2f2'],
                'green' => ['primary' => '#16a34a', 'dark' => '#15803d', 'light' => '#f0fdf4'],
                'orange' => ['primary' => '#f97316', 'dark' => '#ea580c', 'light' => '#fff7ed']
            ];
            $colors = $colorMap[$color ?? 'orange'] ?? $colorMap['orange'];
        @endphp
        body {
