    ...
    resources: {
      fr: {
        ...
        "users": {
          ...
          "send_email_desc": "Envoyer un e-mail à plusieurs adresses",
          "email_addresses": "Adresses e-mail",
          "emails_placeholder": "exemple1@email.com, exemple2@email.com\nexemple3@email.com; exemple4@email.com",
          "emails_help": "Séparez les adresses par des virgules, points-virgules ou sauts de ligne",
          "email_title": "Titre de l'e-mail",
          "email_title_placeholder": "Entrer le titre de l'e-mail",
          "email_message": "Message de l'e-mail",
          "email_message_placeholder": "Entrer le contenu de l'e-mail",
          "email_sent": "E-mail envoyé avec succès",
          "error_sending_email": "Erreur lors de l'envoi de l'e-mail",
          "total_emails": "emails traités",
          "email_color": "Couleur du thème",
          "color_orange": "Orange",
          "color_red": "Rouge",
          "color_green": "Vert",
          "table": {
      ...
      en: {
        translation: {
          ...
          "send_email_desc": "Send email to multiple addresses",
          "email_addresses": "Email Addresses",
          "emails_placeholder": "example1@email.com, example2@email.com\nexample3@email.com; example4@email.com",
          "emails_help": "Separate addresses with commas, semicolons, or line breaks",
          "email_title": "Email Title",
          "email_title_placeholder": "Enter email title",
          "email_message": "Email Message",
          "email_message_placeholder": "Enter email content",
          "email_sent": "Email sent successfully",
          "error_sending_email": "Error sending email",
          "total_emails": "emails processed",
          "email_color": "Theme Color",
          "color_orange": "Orange",
          "color_red": "Red",
          "color_green": "Green",
          "table": {
      ...
      ar: {
        ...
        "users": {
          ...
          "send_email_desc": "إرسال بريد إلكتروني إلى عدة عناوين",
          "email_addresses": "عناوين البريد الإلكتروني",
          "emails_placeholder": "example1@email.com, example2@email.com\nexample3@email.com; example4@email.com",
          "emails_help": "افصل العناوين بفواصل أو فواصل منقوطة أو فواصل أسطر",
          "email_title": "عنوان البريد الإلكتروني",
          "email_title_placeholder": "أدخل عنوان البريد الإلكتروني",
          "email_message": "رسالة البريد الإلكتروني",
          "email_message_placeholder": "أدخل محتوى البريد الإلكتروني",
          "email_sent": "تم إرسال البريد الإلكتروني بنجاح",
          "error_sending_email": "خطأ في إرسال البريد الإلكتروني",
          "total_emails": "بريد إلكتروني تم معالجته",
          "email_color": "لون المظهر",
      ...
      es: {
        ...
        "users": {
          ...
          "send_email_desc": "Enviar correo a múltiples direcciones",
          "email_addresses": "Direcciones de Correo",
          "emails_placeholder": "ejemplo1@email.com, ejemplo2@email.com\nejemplo3@email.com; ejemplo4@email.com",
          "emails_help": "Separe las direcciones con comas, punto y coma, o saltos de línea",
          "email_title": "Título del Correo",
          "email_title_placeholder": "Ingrese el título del correo",
          "email_message": "Mensaje del Correo",
          "email_message_placeholder": "Ingrese el contenido del correo",
          "email_sent": "Correo enviado con éxito",
          "error_sending_email": "Error al enviar el correo",
          "total_emails": "correos procesados",
          "email_color": "Color del Tema",
