    ...
    resources: {
      fr: {
        translation: {
          ...
          "demandes": {
            "title": "Demandes",
            "subtitle": "Gérez et suivez l'ensemble de vos demandes",
            "filter_cin": "Filtrer par CIN",
            "send_to_users": "Envoyer à {{count}} utilisateur(s)",
            ...
            "role_not_allowed": "Votre rôle ne permet pas de créer des demandes.",
            "no_requests_found": "Aucune demande trouvée",
            "create_first_request": "Créer la première demande",
      ...
      en: {
        translation: {
          ...
          "demandes": {
            ...
            "filter_cin": "Filter by National ID",
            "send_to_users": "Send to {{count}} user(s)",
            ...
            "role_not_allowed": "Your role does not allow you to create requests.",
      ...
      ar: {
        translation: {
          ...
          "demandes": {
            "title": "الطلبات",
            "subtitle": "إدارة وتتبع جميع طلباتك",
            "filter_cin": "تصفية برقم البطاقة الوطنية",
            "send_to_users": "إرسال إلى {{count}} مستخدم(ين)",
            "message_sent": "تم إرسال الرسالة بنجاح",
            "error_sending_message": "خطأ أثناء إرسال الرسالة",
            "notifications_sent": "تم إرسال الإشعارات بنجاح",
            "error_sending_notifications": "خطأ أثناء إرسال الإشعارات",
            "confirm_delete": "هل أنت متأكد أنك تريد حذف هذا الطلب؟",
            "role_not_allowed": "دورك لا يسمح بإنشاء طلبات.",
      ...
      es: {
        translation: {
          ...
          "demandes": {
            "title": "Solicitudes",
            "subtitle": "Gestione y haga un seguimiento de todas sus solicitudes",
            "filter_cin": "Filtrar por DNI/CIN",
            "send_to_users": "Enviar a {{count}} usuario(s)",
            ...
            "confirm_delete": "¿Está seguro de que desea eliminar esta solicitud?",
            "role_not_allowed": "Su rol no le permite crear solicitudes.",
            "no_requests_found": "No se encontraron solicitudes",
            "create_first_request": "Crear su primera solicitud",
